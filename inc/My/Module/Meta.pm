...
sub abstract {
    return 'Play with GitHub actions.';
}
...
sub dist_name {
    return 'TRW-Sandbox-GitHub-Actions';
}
...
sub meta_merge {
	...
	resources	=> {
	    bugtracker	=> {
#		web	=> 'https://rt.cpan.org/Public/Dist/Display.html?Name=TRW-Sandbox-GitHub-Actions',
#		# web	=> 'https://github.com/trwyant/perl-TRW-Sandbox-GitHub-Actions/issues',
		mailto  => 'wyant@cpan.org',
	    },
	    license	=> 'http://dev.perl.org/licenses/',
#	    repository	=> {
#		type	=> 'git',
#		url	=> 'git://github.com/trwyant/perl-TRW-Sandbox-GitHub-Actions.git',
#		web	=> 'https://github.com/trwyant/perl-TRW-Sandbox-GitHub-Actions',
#	    },
	},
	@extra,
    };
...
sub version_from {
    return 'lib/TRW/Sandbox/GitHub/Actions.pm';
}
...
My::Module::Meta - Information needed to build TRW::Sandbox::GitHub::Actions
...
This module centralizes information needed to build C<TRW::Sandbox::GitHub::Actions>. It
is private to the C<TRW::Sandbox::GitHub::Actions> package, and may be changed or
...
modules required to build the C<TRW::Sandbox::GitHub::Actions> package, suitable for
...
the modules required to run the C<TRW::Sandbox::GitHub::Actions>
